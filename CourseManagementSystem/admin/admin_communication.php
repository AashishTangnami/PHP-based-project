...
var TR_start = '<TR>';
var TR_end = '</TR>';
var highlight_start = '<TD WIDTH="30"><TABLE CELLSPACING=3 BORDER=0 BGCOLOR=#fff BORDERCOLOR=#000><TR><TD WIDTH=30><B><CENTER>';
...
cal += '<TABLE BORDER=0 CELLSPACING=0 CELLPADDING=3 BGCOLOR="#1abc9c">' + TR_start;
cal += '<TD COLSPAN="' + DAYS_OF_WEEK + '" BGCOLOR="#1abc9c"><CENTER><B>';
